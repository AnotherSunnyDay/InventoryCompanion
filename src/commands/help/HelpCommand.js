...
module.exports = class HelpCommand extends BaseCommand {
  ...
  run(client, message, args) {
    ...
    .addFields({name:"Add Item", value:"!add {item_name: required} [-q {quantity}] [-self]"})
    .addFields({name:"Delete Item", value:"!remove/delete {item_name: required} [-q {quantity}] [-all] [-self]"})
